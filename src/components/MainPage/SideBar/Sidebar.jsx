...
const Sidebar = () => {
  ...
  return (<div className={sidebarClass}>
    {!isOpen
      && <>
        <button className="sidebar__burger-btn" onClick={() => openMenuHandler()} alt='menu button'>
    ...
    {isOpen
      && <>
        <button className="sidebar__close-btn" onClick={() => closeMenuHandler()}>
